...
var G__57299 = document.createElement("div");
com.fulcrologic.fulcro.inspect.element_picker.goog$module$goog$object.set(G__57299,"id",id);

goog.dom.appendChild(document.body,G__57299);
...
var G__57307 = document.createElement("div");
com.fulcrologic.fulcro.inspect.element_picker.goog$module$goog$object.set(G__57307,"id",id);

goog.dom.appendChild(document.body,G__57307);
...
var temp__5751__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57312_SHARP_){
return ((clojure.string.starts_with_QMARK_(p1__57312_SHARP_,"__reactInternalInstance$")) || (clojure.string.starts_with_QMARK_(p1__57312_SHARP_,"__reactFiber$")));
...
var instance = (function (){var G__57322 = target__$1;
if((G__57322 == null)){
return null;
} else {
return com.fulcrologic.fulcro.inspect.element_picker.react_instance(G__57322);
}
})();
...
var G__57354 = goog.dom.getParentElement(target__$1);
target__$1 = G__57354;
continue;
}
} else {
...
var G__57326_57355 = cljs.core.deref(current);
(on_pick.cljs$core$IFn$_invoke$arity$1 ? on_pick.cljs$core$IFn$_invoke$arity$1(G__57326_57355) : on_pick.call(null,G__57326_57355));
...
}catch (e57330){var _ = e57330;
return null;
}})(),new cljs.core.Keyword("fulcro.inspect.ui.element","static-query","fulcro.inspect.ui.element/static-query",1120589305),(function (){try{var G__57332 = comp;
var G__57332__$1 = (((G__57332 == null))?null:com.fulcrologic.fulcro.components.react_type(G__57332));
if((G__57332__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.components.get_query.cljs$core$IFn$_invoke$arity$1(G__57332__$1);
}
}catch (e57331){var _ = e57331;
return null;
}})(),new cljs.core.Keyword("fulcro.inspect.ui.element","query","fulcro.inspect.ui.element/query",113020567),(function (){try{var G__57334 = comp;
var G__57334__$1 = (((G__57334 == null))?null:com.fulcrologic.fulcro.components.react_type(G__57334));
if((G__57334__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.components.get_query.cljs$core$IFn$_invoke$arity$2(G__57334__$1,state_map);
}
...
var app_uuid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57337__$1,new cljs.core.Keyword("fulcro.inspect.core","app-uuid","fulcro.inspect.core/app-uuid",-1096445491));
