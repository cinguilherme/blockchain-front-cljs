 ...
 *   lookup refs.
 */
com.fulcrologic.fulcro.algorithms.denormalize.follow_ref = (function com$fulcrologic$fulcro$algorithms$denormalize$follow_ref(state_map,p__55440){
var vec__55441 = p__55440;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55441,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55441,(1),null);
var ref = vec__55441;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.ref_key = (function com$fulcrologic$fulcro$algorithms$denormalize$ref_key(p__55444){
var vec__55445 = p__55444;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55445,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55445,(1),null);
var ref = vec__55445;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),id)){
return table;
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (n,p__55451){
var map__55452 = p__55451;
var map__55452__$1 = cljs.core.__destructure_map(map__55452);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55452__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
com.fulcrologic.fulcro.algorithms.denormalize.add_join_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_join_BANG_(n,p__55464,entity,state_map,parent_node,idents_seen){
var map__55465 = p__55464;
var map__55465__$1 = cljs.core.__destructure_map(map__55465);
var join_node = map__55465__$1;
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55465__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55465__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
com.fulcrologic.fulcro.algorithms.denormalize.add_union_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_union_BANG_(n,p__55496,entity,state_map,idents_seen){
var map__55497 = p__55496;
var map__55497__$1 = cljs.core.__destructure_map(map__55497);
var join_node = map__55497__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55497__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var link_join_QMARK_ = com.fulcrologic.fulcro.algorithms.denormalize.lookup_ref_QMARK_(key);
...
var union_key__GT_query = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__55502){
var map__55503 = p__55502;
var map__55503__$1 = cljs.core.__destructure_map(map__55503);
var node = map__55503__$1;
var union_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55503__$1,new cljs.core.Keyword(null,"union-key","union-key",1529707234));
...
var vec__55504 = lookup_ref;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55504,(0),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var e = temp__5751__auto__;
var temp__5751__auto____$1 = (function (){var G__55507 = cljs.core.first(v);
return (union_key__GT_query.cljs$core$IFn$_invoke$arity$1 ? union_key__GT_query.cljs$core$IFn$_invoke$arity$1(G__55507) : union_key__GT_query.call(null,G__55507));
})();
if(cljs.core.truth_(temp__5751__auto____$1)){
var target_ast_node = temp__5751__auto____$1;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.denormalize = (function com$fulcrologic$fulcro$algorithms$denormalize$denormalize(p__55510,current_entity,state_map,idents_seen){
var map__55511 = p__55510;
var map__55511__$1 = cljs.core.__destructure_map(map__55511);
var top_node = map__55511__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55511__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55511__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
if(cljs.core.truth_(and__4251__auto__)){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"*","*",345799209,null),(function (){var G__55512 = nil_nodes;
var G__55512__$1 = (((G__55512 == null))?null:cljs.core.first(G__55512));
if((G__55512__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(G__55512__$1);
}
})());
} else {
return and__4251__auto__;
...
var G__55514 = result_node__$1;
var G__55514__$1 = (((G__55514 == null))?null:cljs.core.persistent_BANG_(G__55514));
if((G__55514__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__55514__$1,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var G__55516 = com.fulcrologic.fulcro.algorithms.denormalize.denormalize(ast,starting_entity,state_map,cljs.core.PersistentArrayMap.EMPTY);
if((G__55516 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__55516,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var G__55517 = props;
var G__55517__$1 = (((G__55517 == null))?null:cljs.core.meta(G__55517));
if((G__55517__$1 == null)){
return null;
} else {
return new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","time","com.fulcrologic.fulcro.algorithms.denormalize/time",-375164969).cljs$core$IFn$_invoke$arity$1(G__55517__$1);
}
});
/**
...
var _STAR_root_keys_and_idents_STAR__orig_val__55519 = com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_;
var _STAR_root_keys_and_idents_STAR__temp_val__55520 = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.transient$(cljs.core.PersistentHashSet.createAsIfByAssoc([root_key_or_ident])));
(com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_ = _STAR_root_keys_and_idents_STAR__temp_val__55520);
...
}finally {(com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_ = _STAR_root_keys_and_idents_STAR__orig_val__55519);
}});
/**
...
var map__55523 = cljs.core.meta(prior_props);
var map__55523__$1 = cljs.core.__destructure_map(map__55523);
var visited = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55523__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","visited","com.fulcrologic.fulcro.algorithms.denormalize/visited",823384252));
var source_state_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55523__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","source-state-map","com.fulcrologic.fulcro.algorithms.denormalize/source-state-map",-1097808870));
