...
var i_49691 = (0);
while(true){
if((i_49691 < arr.length)){
(arr[i_49691] = null);

var G__49692 = (i_49691 + (1));
i_49691 = G__49692;
continue;
} else {
}
...
var i_49699 = (self__.level + (1));
while(true){
if((i_49699 <= (new_level + (1)))){
(update[i_49699] = self__.header);

var G__49705 = (i_49699 + (1));
i_49699 = G__49705;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_49707 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_49707[i]));
} else {
x__$2.forward.push((((i < links_49707.length))?(links_49707[i]):null));
}

if((i < links_49707.length)){
(links_49707[i] = x__$2);
} else {
links_49707.push(x__$2);
}
...
var i_49709 = (0);
while(true){
if((i_49709 <= self__.level)){
var links_49710 = (update[i_49709]).forward;
if((x__$1 === (((i_49709 < links_49710.length))?(links_49710[i_49709]):null))){
(links_49710[i_49709] = (x__$1.forward[i_49709]));

var G__49711 = (i_49709 + (1));
i_49709 = G__49711;
continue;
} else {
var G__49712 = (i_49709 + (1));
i_49709 = G__49712;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__49723 = nx;
var G__49725 = (level__$1 - (1));
x = G__49723;
level__$1 = G__49725;
continue;
} else {
var G__49726 = x;
var G__49727 = (level__$1 - (1));
x = G__49726;
level__$1 = G__49727;
continue;
}
