...
com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_ = (function com$fulcrologic$fulcro$algorithms$indexing$index_query_STAR_(prop__GT_classes,p__58503){
var map__58507 = p__58503;
var map__58507__$1 = cljs.core.__destructure_map(map__58507);
var ast = map__58507__$1;
var parent_component = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58507__$1,new cljs.core.Keyword(null,"component","component",1555936782));
var parent_children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58507__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (idx,p__58515){
var map__58517 = p__58515;
var map__58517__$1 = cljs.core.__destructure_map(map__58517);
var child_ast = map__58517__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58517__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var dispatch_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58517__$1,new cljs.core.Keyword(null,"dispatch-key","dispatch-key",733619510));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58517__$1,new cljs.core.Keyword(null,"children","children",-940561982));
var G__58520 = idx;
var G__58520__$1 = ((((cljs.core.vector_QMARK_(key)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),cljs.core.second(key)))))?update_index(G__58520,dispatch_key,parent_key):G__58520);
var G__58520__$2 = ((((cljs.core.vector_QMARK_(key)) && (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),cljs.core.second(key)))))?update_index(G__58520__$1,key,parent_key):G__58520__$1);
var G__58520__$3 = (((key instanceof cljs.core.Keyword))?update_index(G__58520__$2,key,parent_key):G__58520__$2);
if(cljs.core.seq(children)){
return (com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.cljs$core$IFn$_invoke$arity$2(G__58520__$3,child_ast) : com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.call(null,G__58520__$3,child_ast));
} else {
return G__58520__$3;
}
...
var map__58531 = ast;
var map__58531__$1 = cljs.core.__destructure_map(map__58531);
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58531__$1,new cljs.core.Keyword(null,"children","children",-940561982));
 ...
 */
com.fulcrologic.fulcro.algorithms.indexing.link_query_props = (function com$fulcrologic$fulcro$algorithms$indexing$link_query_props(p__58533){
var map__58534 = p__58533;
var map__58534__$1 = cljs.core.__destructure_map(map__58534);
var ast = map__58534__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58534__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58534__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
}),null)),null,-413118601,null);

var map__58550 = app__$1;
var map__58550__$1 = cljs.core.__destructure_map(map__58550);
var state_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58550__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","state-atom","com.fulcrologic.fulcro.application/state-atom",648128366));
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58550__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
var map__58551 = cljs.core.deref(runtime_atom);
var map__58551__$1 = cljs.core.__destructure_map(map__58551);
var root_class = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58551__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","root-class","com.fulcrologic.fulcro.application/root-class",-719803119));
...
var map__58558 = com.fulcrologic.fulcro.raw.components.any__GT_app(this$);
var map__58558__$1 = cljs.core.__destructure_map(map__58558);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58558__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
...
var map__58615 = com.fulcrologic.fulcro.raw.components.any__GT_app(this$);
var map__58615__$1 = cljs.core.__destructure_map(map__58615);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58615__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
var cls = com.fulcrologic.fulcro.raw.components.component_type(this$);
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"action","action",-811238024),(function com$fulcrologic$fulcro$algorithms$indexing$action(p__58621){
var map__58622 = p__58621;
var map__58622__$1 = cljs.core.__destructure_map(map__58622);
var app__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58622__$1,new cljs.core.Keyword(null,"app","app",-560961707));
var _STAR_after_render_STAR__orig_val__58629_58672 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__58630_58673 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__58630_58673);
...
}),null)),null,519421372,null);
}
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__58629_58672);
}
return null;
}),new cljs.core.Keyword(null,"result-action","result-action",-1254630246),(function (env){
var _STAR_after_render_STAR__orig_val__58636 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__58637 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__58637);
...
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__58636);
}})], null);
}));
