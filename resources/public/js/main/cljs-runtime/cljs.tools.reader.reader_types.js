...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_44395 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_44395(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_44396 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_44396(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_44397 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_44397(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_44398 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_44398(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_44399 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_44399(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_44400 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_44400(reader);
}
});
...
var G__44473 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__44474 = s.append(c);
c = G__44473;
s = G__44474;
continue;
}
