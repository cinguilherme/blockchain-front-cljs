...
var len__4864__auto___41680 = arguments.length;
var i__4865__auto___41683 = (0);
while(true){
if((i__4865__auto___41683 < len__4864__auto___41680)){
args__4870__auto__.push((arguments[i__4865__auto___41683]));

var G__41685 = (i__4865__auto___41683 + (1));
i__4865__auto___41683 = G__41685;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq41569){
var G__41570 = cljs.core.first(seq41569);
var seq41569__$1 = cljs.core.next(seq41569);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41570,seq41569__$1);
}));
...
return cljs.core.some((function (p1__41583_SHARP_){
return (p1__41583_SHARP_ === object);
}),history);
});
...
var _STAR_ = (function (p__41586){
var vec__41587 = p__41586;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41587,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41587,(1),null);
if((k === val)){
