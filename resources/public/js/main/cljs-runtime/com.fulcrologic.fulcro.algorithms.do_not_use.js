...
var vec__55399 = ((cljs.core.seq_QMARK_(expr))?cljs.core.ffirst(expr):cljs.core.first(expr));
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55399,(0),null);
...
var expr__$1 = (function (){var G__55404 = expr;
if(cljs.core.seq_QMARK_(expr)){
return cljs.core.first(G__55404);
} else {
return G__55404;
}
})();
...
if(cljs.core.seq_QMARK_(expr)){
var G__55406 = cljs.core.first(expr);
return (com.fulcrologic.fulcro.algorithms.do_not_use.join_key.cljs$core$IFn$_invoke$arity$1 ? com.fulcrologic.fulcro.algorithms.do_not_use.join_key.cljs$core$IFn$_invoke$arity$1(G__55406) : com.fulcrologic.fulcro.algorithms.do_not_use.join_key.call(null,G__55406));
} else {
return expr;
...
var i__4865__auto___55469 = (0);
while(true){
if((i__4865__auto___55469 < len__4864__auto___55467)){
args__4870__auto__.push((arguments[i__4865__auto___55469]));

var G__55470 = (i__4865__auto___55469 + (1));
i__4865__auto___55469 = G__55470;
continue;
} else {
}
break;
...
/** @this {Function} */
(com.fulcrologic.fulcro.algorithms.do_not_use.deep_merge.cljs$lang$applyTo = (function (seq55419){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq55419));
}));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [["The composed root query is not valid EQL. The app may crash. See `(comp/get-query ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__55458 = query;
var G__55458__$1 = (((G__55458 == null))?null:cljs.core.meta(G__55458));
var G__55458__$2 = (((G__55458__$1 == null))?null:new cljs.core.Keyword(null,"component","component",1555936782).cljs$core$IFn$_invoke$arity$1(G__55458__$1));
if((G__55458__$2 == null)){
return null;
} else {
return (component_name_fn.cljs$core$IFn$_invoke$arity$1 ? component_name_fn.cljs$core$IFn$_invoke$arity$1(G__55458__$2) : component_name_fn.call(null,G__55458__$2));
}
})()),")`"].join(''),query], null);
}),null)),null,1443228229,null);
} else {
}
