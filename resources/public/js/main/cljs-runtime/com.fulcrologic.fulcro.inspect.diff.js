...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (adds,p__45552){
var vec__45553 = p__45552;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45553,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45553,(1),null);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (rems,p__45565){
var vec__45566 = p__45565;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45566,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45566,(1),null);
var temp__5751__auto__ = cljs.core.find(b,k);
if(cljs.core.truth_(temp__5751__auto__)){
var vec__45569 = temp__5751__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45569,(0),null);
var vb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45569,(1),null);
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(rems,(function (){var G__45572 = k;
if(cljs.core.map_QMARK_(k)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__45572,new cljs.core.Keyword("fulcro.inspect.lib.diff","key?","fulcro.inspect.lib.diff/key?",325118813),true);
} else {
return G__45572;
}
})());
...
com.fulcrologic.fulcro.inspect.diff.patch_updates = (function com$fulcrologic$fulcro$inspect$diff$patch_updates(x,p__45577){
var map__45578 = p__45577;
var map__45578__$1 = cljs.core.__destructure_map(map__45578);
var updates = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45578__$1,new cljs.core.Keyword("fulcro.inspect.lib.diff","updates","fulcro.inspect.lib.diff/updates",221795125));
...
com.fulcrologic.fulcro.inspect.diff.patch_removals = (function com$fulcrologic$fulcro$inspect$diff$patch_removals(x,p__45584){
var map__45585 = p__45584;
var map__45585__$1 = cljs.core.__destructure_map(map__45585);
var removals = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45585__$1,new cljs.core.Keyword("fulcro.inspect.lib.diff","removals","fulcro.inspect.lib.diff/removals",-1638817439));
...
var vec__45586 = cljs.core.first(rem);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45586,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45586,(1),null);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(final$,k,(function (p1__45583_SHARP_){
var G__45589 = p1__45583_SHARP_;
var G__45590 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("fulcro.inspect.lib.diff","removals","fulcro.inspect.lib.diff/removals",-1638817439),v], null);
return (com.fulcrologic.fulcro.inspect.diff.patch_removals.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.inspect.diff.patch_removals.cljs$core$IFn$_invoke$arity$2(G__45589,G__45590) : com.fulcrologic.fulcro.inspect.diff.patch_removals.call(null,G__45589,G__45590));
}));
} else {
