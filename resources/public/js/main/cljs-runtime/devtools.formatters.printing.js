...
var len__4864__auto___42470 = arguments.length;
var i__4865__auto___42471 = (0);
while(true){
if((i__4865__auto___42471 < len__4864__auto___42470)){
args__4870__auto__.push((arguments[i__4865__auto___42471]));

var G__42472 = (i__4865__auto___42471 + (1));
i__4865__auto___42471 = G__42472;
continue;
} else {
}
break;
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42293,G__42294,seq42292__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__42374_SHARP_){
return (!((cljs.core.meta(p1__42374_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42402__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e42403){var _e__40465__auto__ = e42403;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e42411){var _e__40465__auto__ = e42411;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__42425 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__42426 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__42426);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42429__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__42425);
}});
...
var temp__5751__auto___42490 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___42490)){
var managed_print_level_42491 = temp__5751__auto___42490;
var _STAR_print_level_STAR__orig_val__42445_42493 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__42446_42494 = managed_print_level_42491;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__42446_42494);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__42435_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__42435_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__42445_42493);
}} else {
job_fn();
}
